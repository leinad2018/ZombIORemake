...
function loadAssets() {
    ZIRAssetLoader.loadAsset("enemy", "../assets/enemy.png");
    ZIRAssetLoader.loadAsset("grass", "../assets/grass.png");
    ZIRAssetLoader.loadAsset("snow", "../assets/snow.png");
    ZIRAssetLoader.loadAsset("circle", "../assets/circle.png");
    ZIRAssetLoader.loadAsset("player", "../assets/player.png");
    ZIRAssetLoader.loadAsset("spite", "../assets/spite.jpg");
    ZIRAssetLoader.loadAsset("rock", "../assets/rock.png");
    ZIRAssetLoader.loadAsset("boomerang", "../assets/boomerang.png");
    ZIRAssetLoader.loadAsset("health", ["../assets/health.png", "../assets/rock.png"]);
}
